				...
				<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
					<div className='grid grid-cols-1 lg:grid-cols-2 gap-12'>
						...
						<div>
							...
							<div className='space-y-4'>
								...
								>
									...
									<div>
										...
										<p className='text-sm' style={{ color: 'hsl(25 80% 50%)' }}>
											{company.email}
										</p>
									</div>
								</a>
							...
							>
								<iframe
									src='https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3005.8139115535205!2d69.07091007556389!3d41.11675501273906!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zNDHCsDA3JzAwLjMiTiA2OcKwMDQnMjQuNiJF!5e0!3m2!1suz!2sus!4v1779466487596!5m2!1suz!2sus'
									width='100%'
									height='100%'
									style={{ border: 0 }}
									allowFullScreen
						...
						{/* Contact form */}
						<div
							className='p-4 sm:p-8 rounded-2xl border'
							style={{ background: 'var(--card)', borderColor: 'var(--border)' }}
						>
